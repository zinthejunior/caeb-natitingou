...
export function AdvancedFilters({
  ...
  return <div className="fixed inset-0 z-50 bg-black/50 flex items-start pt-20">
    ...
    /* Genres */
        ...
        <div>
          ...
          <div className="space-y-2">
            {genres.map((genre) => <label key={genre} className="flex items-center gap-3 cursor-pointer group">
                <input
    type="checkbox"
  ...
  />
    ...
    /* Disponibilité */
        ...
        <div>
          ...
          <div className="space-y-2">
            {["all", "available", "unavailable"].map((option) => <label key={option} className="flex items-center gap-3 cursor-pointer group">
                <input
    type="radio"
    name="availability"
    value={option}
