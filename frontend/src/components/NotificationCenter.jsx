...
export function NotificationCenter({ onClose }) {
  ...
  const basculerLecture = (id, estLue) => {
  ...
  >
    ...
    /* Indicateur de chargement */
        ...
        {chargement && <div className="py-4 text-center text-sm text-muted">Chargement…</div>}

        {
    /* Message quand la liste est vide */
  }
        {!chargement && notifications.length === 0 && <div className="py-6 text-center text-sm text-muted">Aucune notification</div>}
