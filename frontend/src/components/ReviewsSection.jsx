...
export function ReviewsSection({ reviews, onAddReview, isAuthenticated }) {
  ...
  const averageRating = reviews.length > 0 ? (reviews.reduce((sum, r) => sum + (r.rating ?? 0), 0) / reviews.length).toFixed(1) : 0;
  return <div className="space-y-6">
    ...
    /* Stats des avis */
        ...
        {reviews.length > 0 && <div className="flex items-center gap-6 mb-6 surface dark:bg-library-dark-secondary rounded-xl p-4">
            <div>
    ...
    /* Ajouter un avis */
      ...
      {isAuthenticated && <div className="surface dark:bg-library-dark-secondary rounded-xl p-4 sm:p-6">
          {!isExpanded ? <Button onClick={() => setIsExpanded(true)} className="w-full" variant="outline">
              ✎ Ajouter votre avis
  ...
  >
    ...
    /* Liste des avis */
      ...
      <div className="space-y-4">
        {reviews.length === 0 ? <div className="text-center py-8 text-slate-700 dark:text-library-dark-muted">
    ...
    /* Info utilisateur */
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2">
                      ...
                      {review.isUserReview && <Badge className="bg-library-primary dark:bg-library-dark-accent text-white text-xs">
                          Mon avis
                        </Badge>}
                    </div>
