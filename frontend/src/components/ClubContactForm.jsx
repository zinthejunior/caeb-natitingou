...
export function ClubContactForm({
  ...
  return <div className="fixed inset-0 bg-overlay flex items-center justify-center z-50 p-4">
  ...
  >
    ...
    /* Informations sur le responsable (optionnel) */
          ...
          {club.manager && <div className="bg-surface-weak dark:bg-library-surface rounded-lg p-4 border border-muted mb-6">
