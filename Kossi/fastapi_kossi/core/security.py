...
async def verify_jwt_token(
    ...
    # Verifier que la bibliotheque jose est disponible et qu'une cle secrete est definie
    if not JOSE_AVAILABLE or not API_SECRET_KEY:
        logger.error("python-jose non installe ou secret JWT absent - authentification JWT indisponible")
        raise HTTPException(
