...
// Clé API pour l'authentification auprès du backend FastAPI
const API_KEY = process.env.NEXT_PUBLIC_API_KEY || "dev-test-key-12345";

/**
 * Retourne les headers HTTP standards avec authentification API
 */
