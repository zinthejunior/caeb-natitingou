"""
scripts/init_database.py — Script pour initialiser la BD avec des donnees de test

Ce script peuple la BD PostgreSQL/partagée avec des exemples de livres, clubs et evenements
